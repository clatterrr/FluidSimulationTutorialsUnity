...
for t in range(0,tmax-1):
    ...
    for i in range(0,nmax-1):
        u1pred[t,i] = U1[t,i] + 0.5 * (U1[t,i+1] - U1[t,i] - dt / dx * (F1[t,i+1] - F1[t,i]))
        u2pred[t,i] = U2[t,i] + 0.5 * (U2[t,i+1] - U2[t,i] - dt / dx * (F2[t,i+1] - F2[t,i]))
        u3pred[t,i] = U3[t,i] + 0.5 * (U3[t,i+1] - U3[t,i] - dt / dx * (F3[t,i+1] - F3[t,i]))
    ...
    for i in range(1,nmax-1):
        U1[t+1,i] = U1[t,i] - dt/dx * (F1[t+1,i] - F1[t+1,i-1])
        U2[t+1,i] = U2[t,i] - dt/dx * (F2[t+1,i] - F2[t+1,i-1])
        U3[t+1,i] = U3[t,i] - dt/dx * (F3[t+1,i] - F3[t+1,i-1])
